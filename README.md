...
Open "vdrivewic64.prg" with a HEX editor and point the URL to your local VDRIVE Servers IP address. Max 80 characters - for example HTTP://192.168.1.222/. Note: trailing slash is needed or the formed URLs will not be correct.
